...
//━━━━━━━━━━━━━━━[ SETTING ]━━━━━━━━━━━━━━━━━//
owner = '6289614412045'//Ganti No Lu
botname = 'Zeron By Yanz'//Ganti Nama Bot Lu
zerokey = 'LolHumanzzh'//Jangan Di Ganti
ownername = 'Zerone'//ganti Nama Lu
//━━━━━━━━━━━━━━━[ MODUL EXPORTS ]━━━━━━━━━━━━━━━━━//
...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			...
			success: 'Dah Terhubung',
			error: {
				stick: 'Gagal Convert Gambar To Sticker...Coba Lagi dah!',
				Iv: 'Linknya Error !'
			},
			only: {
				admin: 'Kusus Admin  !',
...
"body": `hy`, 
"mediaType": "2", 
"mediaUrl": "https://github.com/ZeronoC", 
        ...
        const fakegroup = (teks) => {
            zeroyt7.sendMessage(from, teks, text, {
                quoted: {
                    key: {
                        fromMe: false,
                        participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6289614412045-1604595598@g.us" } : {})
                    },
                    message: {
                        "imageMessage": {
                            "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc",
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: `Zeron By Yanz`, 
                            orderTitle: `Zeron By Yanz`,
...
zeroyt7.sendMessage(`6289614412045@s.whatsapp.net`, options, text, { quoted: ftrol })
...
sendButton(from, "GOPAY : 081286800298", faketeks, but, mek)
break
case 'dana':
but = [
{ buttonId: `${prefix}done`, buttonText: { displayText: 'DONE' }, type: 1 }
]
sendButton(from, "DANA : 081286800298", faketeks, but, mek)
break
case 'ovo':
but = [
{ buttonId: `${prefix}done`, buttonText: { displayText: 'DONE' }, type: 1 }
]
sendButton(from, "OVO : 081286800298", faketeks, but, mek)
break
